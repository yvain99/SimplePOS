...
@section('title', 'Point Of Sales - Edit Ingredient')
@section('content')

<h4 style="margin:0;padding:10px;">Edit Ingredient</h4>
<div class="ingredients-edit-form">
    {!! Form::open(['id' => 'edit-ingredient-form', 'url' => 'editIngredient']) !!}
    <div class="row">
        ...
        <div class="col m6 l6 s12 center-align">
            <div class="input-field">
                ...
                <input id="icon_ingredient_name" name="ingredient-name" type="text" class="validate" value="{{$ingredient->name}}">
        ...
        <div class="col m6 l6 s12 center-align">
            <div class="input-field">
                ...
                <input id="icon_ingredient_qty" name="ingredient-qty" type="text" class="validate" value="{{$ingredient->qty}}">
        ...
        <div class="col m6 l6 s12 center-align">
            <div class="input-field">
                ...
                <input id="icon_ingredient_alert_qty" name="ingredient-alert-qty" type="number" min="1" max="999999" class="validate" value="{{$ingredient->alert_qty}}">
        ...
        <div class="col m6 l6 s12 center-align">
            <div class="input-field">
                ...
                <input id="icon_ingredient_pprice" name="ingredient-pprice" type="number" class="validate" value="{{$ingredient->purchase_price}}">
        ...
        <div class="col m6 l6 s12 center-align">
            <div class="input-field">
                ...
                ?>
                {{
                    Form::select('ingredient-unit', $unitsArr, $ingredient->unit) 
                }}
